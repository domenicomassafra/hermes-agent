...
@pytest.mark.asyncio
async def test_new_session_skips_home_onboarding_when_runtime_config_has_home(monkeypatch):
    """The running config is authoritative after /sethome, even without env."""
    import gateway.run as gateway_run
