...
class AIAgent:
    ...
    def _emit_status(self, message: str, *, event_type: str = "lifecycle") -> None:
        """Emit a status message to CLI and gateway channels.
        ...
        it through ``status_callback(event_type, ...)``.  Terminal notices
        remain visible locally while chat gateways can suppress them when the
        same condition is rendered as the final reply.
